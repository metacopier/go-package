...
func (r ApiCreateReportPerformanceRequest) ReportPerformanceParametersDTO(reportPerformanceParametersDTO ReportPerformanceParametersDTO) ApiCreateReportPerformanceRequest {
	r.reportPerformanceParametersDTO = &reportPerformanceParametersDTO
	return r
}

func (r ApiCreateReportPerformanceRequest) Execute() (*ReportPerformanceDTO, *http.Response, error) {
	return r.ApiService.CreateReportPerformanceExecute(r)
}
...
func (a *ReportAPIAPIService) CreateReportPerformanceExecute(r ApiCreateReportPerformanceRequest) (*ReportPerformanceDTO, *http.Response, error) {
	...
	localVarPath := localBasePath + "/rest/api/v1/reports/performance"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.reportPerformanceParametersDTO == nil {
		return localVarReturnValue, nil, reportError("reportPerformanceParametersDTO is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.reportPerformanceParametersDTO
	if r.ctx != nil {
